...
function NewPensionerGraph({ type, reloadGraph }: any) {
  console.log("BasicGraph is called");
  ...
  useEffect(() => {
    try {
      ...
      setUniqueCategories(["New Pensioners"]);
      ...
      if (selectedGraphTab === "Overview") {
        ...
        const trendData = data.map((item) => ({
          month: item.month,
          "New Pensioners": selectedTab == "count" ? item.count : item.amount,
        }));
...
export default NewPensionerGraph;

...
import { generateSummaryQuery, getMonthYear } from "../utils/otherUtils";
  ...
  useEffect(() => {
    try {
      ...
      if (selectedGraphTab === "Overview") {
        ...
        console.log("Filtered Categories (non-zero):", filteredCategories);
        ...
        console.log("Filtered Trend Data:", filteredTrendData);
